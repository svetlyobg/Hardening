...
rem reg add HKCU\Software\Policies\Microsoft\Office\12.0\outlook\options\rss /v EnableAttachments /t REG_DWORD /d 0 /f
rem reg add HKCU\Software\Policies\Microsoft\Office\13.0\outlook\options\rss /v EnableAttachments /t REG_DWORD /d 0 /f
rem reg add HKCU\Software\Policies\Microsoft\Office\14.0\outlook\options\rss /v EnableAttachments /t REG_DWORD /d 0 /f
reg add HKCU\Software\Policies\Microsoft\Office\15.0\outlook\options\rss /v EnableAttachments /t REG_DWORD /d 0 /f
rem reg add HKCU\Software\Policies\Microsoft\Office\16.0\outlook\options\rss /v EnableAttachments /t REG_DWORD /d 0 /f